        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button variant="hero" size="sm" asChild>
              <a href="https://app.chums.org/login#register" onClick={() => trackButtonClick('Get Started', 'Navigation')}>
                Get Started
              </a>
            </Button>
          </div>
      ...
      {isOpen && <div className="md:hidden bg-background/95 backdrop-blur-md border-b border-border/50">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="flex flex-col space-y-2 pt-4">
              ...
              <Button variant="hero" size="sm" asChild>
                <a href="https://app.chums.org/login#register" onClick={() => trackButtonClick('Get Started', 'Mobile Navigation')}>
                  Get Started
                </a>
              </Button>
            </div>
